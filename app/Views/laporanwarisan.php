  ...
  <body>
   ...
   <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1>Laporan Surat Keterangan Ahli Waris </h1>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="bi bi-house-door fs-6"> </i></li>
          <li class="breadcrumb-item active"><a href="/laporanwarisan"> Laporan Surat Keterangan Ahli Waris</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">  
              <div class="table-responsive">
                <h2> Laporan Keterangan Ahli Waris</h2>
                  <form action="<?php echo base_url('laporanwarisan'); ?>" method="post">
