  ...
  <body>
   ...
   <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1>Laporan Surat Pengantar KK</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="bi bi-house-door fs-6"> </i></li>
          <li class="breadcrumb-item active"><a href="/laporankk"> Laporan Surat Pengantar KK</a></li>
        </ul>
      </div>
          ...
          <div class="tile">
            <div class="tile-body">  
              <div class="table-responsive">
                <h2>Laporan Pengantar Surat Kartu Keluarga</h2>
                  <form action="<?php echo base_url('laporankk'); ?>" method="post">
