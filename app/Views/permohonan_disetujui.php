...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h4>List Permohonan Disetujui</h4>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="bi bi-house-door fs-6"></i></li>
          <li class="breadcrumb-item"> Dashboard</a></li>
          <li class="breadcrumb-item active"><a href="/permohonan_disetujui">List Permohonan Disetujui</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  <h2>List Permohonan Disetujui</h2>
                  <thead>
                  <tr>
                    <th>No</th>
                    <th>Nama Pemohon</th>
