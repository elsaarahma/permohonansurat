...
class DomisiliModel extends Model
{
    ...
    protected $allowedFields    = ['id_kategori_surat','nama_pemohon','nik','alamat_lama','alamat_baru','tanggal_pindah','alasan_pindah','jml_anggota','tgl_pembuatan'];
    ...
    public function editData($id_domisili, $data)
    {
        return $this->db->table($this->table)->where($this->primaryKey, $id_domisili)->update($data);
    }

    function deleteData($id_domisili)
    {
    return $this->delete($id_domisili);
    }
